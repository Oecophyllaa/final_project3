    ...
    <div class="row justify-content-center form-bg-image" data-background-lg="../../assets/img/illustrations/signin.svg">
      <div class="col-12 d-flex align-items-center justify-content-center">
        <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
          ...
          <form action="<?= BASEURL; ?>/auth/signin" method="POST" class="mt-4">
            <!-- Form -->
            <div class="form-group mb-4">
              ...
              <div class="input-group">
                ...
                <input type="email" name="email" id="email" class="form-control" placeholder="example@company.com" autofocus required />
              </div>
            </div>
            <!-- End of Form -->
          ...
          <div class="d-flex justify-content-center align-items-center mt-4">
            <span class="fw-normal">
              Not registered?
              <a href="<?= BASEURL; ?>/auth/signup" class="fw-bold">Create account</a>
            </span>
          </div>
        </div>
      </div>
