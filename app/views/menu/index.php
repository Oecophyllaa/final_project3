          ...
          <?php foreach ($data['menu'] as $menu) : ?>
            ...
            <tr>
              ...
              <td>
                ...
                <!-- Edit -->
                <a href="<?= BASEURL; ?>/menu/edit/<?= $menu['id_menu']; ?>" type="button" class="btn btn-warning d-inline-flex align-items-center" title="Edit" data-bs-toggle="tooltip" data-bs-placement="top">
                  <svg class="icon icon-xxs" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path>
                  </svg>
                </a>
                <!-- Destroy Modal -->
                <button type="button" class="btn btn-danger d-inline-flex align-items-center" data-href="<?= BASEURL; ?>/menu/destroy/<?= $menu['id_menu']; ?>" data-bs-toggle="modal" data-bs-target="#destroyMenu">
                  <svg class="icon icon-xxs" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
